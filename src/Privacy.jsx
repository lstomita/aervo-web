...
function Privacy() {
  return (
    <div style={styles.pageContainer}>
      ...
      {/* 1. PROFESSIONAL HEADER (Trust Anchor) */}
      <nav style={styles.navbar}>
        <div style={styles.navContent}>
          <div style={styles.brand}>
            {/* Valid because file is in /public/icon-192.png */}
      ...
      <div style={styles.contentWrapper}>
        {/* 2. HEADER SECTION WITH BRAND COLOR */}
          ...
          <div style={styles.prose}>
            ...
            <Section title="2. Information We Collect">
              ...
              <ul style={styles.list}>
                ...
                <li style={styles.listItem}><strong>Travel Inputs & Drafts:</strong> We store the itinerary details <strong>and saved places ("Bucket List" items)</strong> you manually input (such as locations, dates, and times). This includes <strong>Draft Trips</strong> (incomplete or "Sandbox" itineraries), which are saved to our secure cloud servers to allow you to resume planning across devices.</li>
            ...
            <Section title="4. Community and Collaboration">
              ...
              <ul style={styles.list}>
                 ...
                 <li style={styles.listItem}><strong>Optional Anonymity:</strong> You may toggle settings to hide your <strong>Username/Avatar</strong> and <strong>Trip Budget</strong> from the public view while keeping the itinerary public.</li>
              ...
              <p style={{marginTop: '10px'}}><strong>Group Collaboration:</strong> When you invite specific users to join a private trip, you grant them <strong>Editor access</strong>. Editors can view and modify itinerary items and view private notes. Only the Trip Owner can delete the trip or manage permissions.</p>
            </Section>

            <Section title="5. How We Use Artificial Intelligence (AI)">
              We use AI services (such as Google Gemini) to <strong>process images you upload</strong> (e.g., screenshots of tickets or reservations) for the purpose of automatically extracting and autofilling itinerary details ("Smart Scan").
              Data processed for this feature is transient and is not used by us or our AI partners to train public AI models.
            </Section>

            <Section title="6. Affiliate Links & Third Parties">
            ...
            <Section title="7. Google Maps Integration">
              Our application uses the Google Maps API(s) to display interactive maps and location data. By using these features, you agree to be bound by 
              <a href="https://maps.google.com/help/terms_maps.html" target="_blank" rel="noopener noreferrer" style={styles.link}> Google’s Terms of Service</a> and 
              <a href="https://www.google.com/policies/privacy/" target="_blank" rel="noopener noreferrer" style={styles.link}> Google’s Privacy Policy</a>.
            </Section>

            <Section title="8. Data Security">
              We implement industry-standard security measures (via Google Firebase) to protect your personal information from unauthorized access, alteration, or destruction.
            </Section>
...
const styles = {
  pageContainer: {
    backgroundColor: '#09090b', // Deep rich black/grey
    minHeight: '100vh',
    color: '#e4e4e7',
  ...
  navbar: {
    width: '100%',
    padding: '1rem 0',
    backgroundColor: 'rgba(9, 9, 11, 0.8)', // Glassmorphism
  ...
  gradientLine: {
    ...
    width: '60px',
    borderRadius: '2px',
    background: 'linear-gradient(90deg, #6366F1 0%, #a855f7 100%)', // Brand Gradient
  },
  card: {
    backgroundColor: '#18181b', // Slightly lighter card background
    borderRadius: '16px',
    padding: '3rem',
